...
- Read [MANUAL-E2E-RUNBOOK.md](docs/MANUAL-E2E-RUNBOOK.md) before any manual extension E2E, browser launch, unpacked-extension verification, or local Native Messaging bridge test.
